        ...
        <form className='bg-white text-black md:w-2/3 p-10' onSubmit={createTimerHandler}>
          ...
          <div className="bg-transparentGreen rounded-md p-4 mb-8">
            ...
            <div className="mb-5">
              ...
              <input required className="py-1 px-2 w-40 text-black inline-block align-bottom" ref={nameInputRef} type="text" id="name" />
            </div>
          ...
          <div className="bg-transparentGreen rounded-md p-4 mb-8">
            ...
            <div className="mb-5">
              ...
              <input className="py-1 px-2 w-16 text-black inline-block align-bottom" onChange={updatePreviewHandler} ref={activeInputRef} type="number" id="active" defaultValue="40"/> seconds
            </div>
            <div className="mb-5">
              <label className="block mb-1 font-semibold" htmlFor="rest">Rest Interval</label>
              <input className="p-1 px-2 w-16 text-black inline-block align-bottom" onChange={updatePreviewHandler} ref={restInputRef} type="number" id="rest" defaultValue="20"/> seconds
            </div>
          </div>
          <div className="flex bg-transparentGreen rounded-md p-4 mb-8">
            ...
            <div>
              ...
              <div className={exerciseInputMethod === 'automatic' ? 'disabled opacity-30' : ''}>
                ...
                <textarea onKeyDown={addRow} disabled={exerciseInputMethod === 'automatic'} className="bg-lines bg-sizelines leading-8 mt-4 px-2 text-black" onBlur={updatePreviewHandler} cols="30" rows={exerciseInputRows} ref={exerciseTitleRef}>
                </textarea>
              </div>
            </div>
          </div>
